const TRANSLATIONS = {
  zh: {
    ...
    aboutTitle: '关于',
    aboutApp: 'Deepseek-Harness-Desktop',
    aboutAppMeta: 'github.com/ChisaAlter/Deepseek-Harness-Desktop',
    aboutVersion: '当前版本 {version}',
    aboutCheckUpdate: '检测更新',
    aboutInstallUpdate: '在线安装',
    aboutReleases: 'GitHub 发行版',
    aboutUpdateChecking: '正在检测更新…',
    aboutUpdateNone: '暂无 GitHub 发行版。',
    aboutUpdateCurrent: '已是最新版本 {latest}',
    aboutUpdateAvailable: '发现新版本 {latest}',
    aboutUpdateDownloading: '正在下载 {percent}%',
    aboutUpdateInstalling: '已启动安装程序，请按向导完成安装。',
    aboutUpdateOpenedPage: '未找到安装包，已打开 GitHub 发行页。',
    aboutUpdateError: '检测或安装失败：{message}',
  ...
  en: {
    ...
    aboutInstallUpdate: 'Install online',
    aboutReleases: 'GitHub releases',
    aboutUpdateChecking: 'Checking for updates…',
    aboutUpdateNone: 'No GitHub release yet.',
    aboutUpdateCurrent: 'You are on the latest version {latest}',
    aboutUpdateAvailable: 'New version {latest} is available',
    aboutUpdateDownloading: 'Downloading {percent}%',
    aboutUpdateInstalling: 'Installer launched. Follow the wizard to finish.',
    aboutUpdateOpenedPage: 'No installer asset found. Opened the GitHub releases page.',
    aboutUpdateError: 'Update failed: {message}',
