...
export class FakeApiClient implements IApiClient {
  ...
  onDelete: (payload: unknown) => Promise<RpcResponse<{ deletedSessionIds: SessionId[]; archivedSessionIds: SessionId[] }>> =
    () => Promise.resolve(ok({ deletedSessionIds: [], archivedSessionIds: [] }))
