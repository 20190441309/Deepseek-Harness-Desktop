...
export const zh = {
  ...
  modeLan: '局域网',
  modeRelay: '服务器中继',
  lanPlaintextWarning: '局域网模式走明文 HTTP 且对整个网段开放，仅限可信局域网（家庭/办公内网）使用；公共 Wi‑Fi 请改用 HTTPS 中继或关闭远程。',
  qr: '配对二维码',
  offHint: '开启后显示配对二维码',
  noQr: '还没有可扫描的二维码',
  devices: '已连接设备',
...
export const en = {
  ...
  modeLan: 'LAN',
  modeRelay: 'Relay',
  lanPlaintextWarning: 'LAN mode serves plaintext HTTP to the whole subnet. Use it only on a trusted network (home/office LAN); on public Wi‑Fi switch to the HTTPS relay or turn Remote off.',
  qr: 'Pairing QR code',
