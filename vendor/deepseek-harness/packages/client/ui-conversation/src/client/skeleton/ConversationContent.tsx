...
import type { ConversationPhase } from '../contract/snapshot.ts'
import { HeroShell, WorkspaceChip, workspaceLabel } from './EmptyHero.tsx'
import css from './ConversationRoot.module.css'

type ConversationContentProps = Omit<ConversationSlotProps, 'useSession' | 'useConversation'> & {
  session: SessionSnapshot | undefined
  /** The shell's own phase before presentation-ownership folding (blank sessions behind a business-owned canvas stay blank here). */
  shellPhase: ConversationPhase
  /** A plugin-owned presentation covers this session's body. */
...
export function ConversationContent({
  sessionId, session, shellPhase, presentationOwned, phase, hero, useSessions, useSessionPendingInteraction,
  useWorkspaces, useInput, useComposerBlock, renderSlot, renderSlotChain,
  selectWorkspace, selectNoDirectory, t, onHandleStart, onHandleDrag, onHandleCommit, onHandleEnd,
