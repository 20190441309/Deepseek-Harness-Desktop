...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-not-archived'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('session-running'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('session-live-unowned'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({
    code: z.literal('session-delete-partial'),
    message: z.string(),
    details: z.object({
      sessionId: z.string(),
  ...
  z.object({
    code: z.literal('session-delete-incomplete'),
    message: z.string(),
    details: z.object({
      sessionId: z.string(),
      deletedSessionIds: z.array(z.string()),
  ...
  z.object({ code: z.literal('session-delete-in-progress'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
