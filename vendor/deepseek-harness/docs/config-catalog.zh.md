...
来源：[`packages/llm/llm-vision-fallback/src/index.ts:78`](../packages/llm/llm-vision-fallback/src/index.ts)
...
- `@deepseek-ai/dsh-host-mcp-servers` — 需要 `mcpServersFile` · `loader`（[`packages/host/mcp-servers/src/index.ts`](../packages/host/mcp-servers/src/index.ts)）
- `@deepseek-ai/dsh-host-plugin-inventory` — 需要 `loader`（[`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts)）
- `@deepseek-ai/dsh-host-skill-inventory` — 需要 `agents` · `skills`（[`packages/host/skill-inventory/src/index.ts`](../packages/host/skill-inventory/src/index.ts)）
