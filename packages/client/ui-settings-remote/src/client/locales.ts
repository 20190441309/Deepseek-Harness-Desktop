/** Copy dictionaries for the Remote phone popup. */
...
export const zh = {
  ...
  devices: '已连接设备',
  devicesManage: '设备管理',
  devicesEmpty: '还没有已连接的手机。扫码后会出现在这里。',
  devicesOnline: '在线',
...
export const en = {
  ...
  devicesEmpty: 'No phones are bound yet. Scan the QR code to add one.',
