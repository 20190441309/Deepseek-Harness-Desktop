...
- `src/main/harness-controller.js` 仅限 sticky skip 判定委托与启动 `patchFiles` 组装（install + dsh-im overlay 所有启动、usage overlay 仅全量；不动其余生命周期语义）
