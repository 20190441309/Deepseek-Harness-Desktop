...
| **id** | `mobile-remote` |
| **status** | `active` |
| **last verified** | 2026-08-27 — Android APK 内置同一 v2 SPA 并由安全 WebView asset origin 承载：原生扫码/粘贴严格校验 offer v2，SPA localStorage sticky 可离开 LAN 冷启动，并删除不可达的 HTTP v1 原生 Chat 客户端。 |
